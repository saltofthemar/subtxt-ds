...
function postcssProcessCalcs() {
  return {
    ...
    Once(root) {
      ...
      function calculateFluidValues(multiplier = 1, step = 0) {
      ...
      function createClampExpression(values) {
      ...
      function extractMultiplier(expr, varName) {
